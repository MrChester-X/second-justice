...
/**
 * Цвета заданы через CSS-переменные, а не хексами: это позволяет переключать
 * оформление, не меняя ни одного класса в компонентах. Значения переменных
 * живут в app/globals.css — там же описаны обе темы.
 *
